...
namespace SistemaVenta.AplicacionWeb.Controllers
{
    public class NegocioController : Controller
    {
        ...
        [HttpGet]
        public async Task<IActionResult> Obtener() //devuelve info del negocio
        {
        ...
        [HttpPost]
        public async Task<IActionResult> GuardarCambios([FromForm]IFormFile logo, [FromForm]string modelo) //devuelve info del negocio
        {
            GenericResponse<VMNegocio> gResponse = new GenericResponse<VMNegocio>();
