        ...
        public async Task<Venta> Registrar(Venta entidad)
        {
            ...
            using(var transaction = _dbContext.Database.BeginTransaction())
            {
                try
                {
                    ...
                    {
                        Producto producto_encontrado = _dbContext.Productos.Where(p=>p.IdProducto==dv.IdProducto).First();//devuelve el primero encontrado

                        producto_encontrado.Stock = producto_encontrado.Stock - dv.Cantidad; //reduce stock
                        _dbContext.Productos.Update(producto_encontrado); //actualizamos producto con stock ya disminuido
                    }
